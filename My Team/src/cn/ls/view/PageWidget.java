...
public class PageWidget extends FrameLayout {
    ...
    public PageWidget(Context context) {
        ...
        viewInit();
        this.context = context;
        System.out.println("�������е�currentPosition" + currentPosition);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (i == 3) {
            ...
            System.out.println(mWidth + "�����Ļ��()");
            System.out.println(mHeight + "��ø�()");
        } else {
            mWidth = getWidth();
            mHeight = getHeight();
    ...
    private void calcPoints() {
        ...
        // ����������,ʹ����ָ�����������ͼ���ܷ����м���
        if (!isAnimated) {
            if (mCornerX == 0 && mBezierStart1.x > mWidth / 2) { // ���һ���ʱ
                float f1 = Math.abs(mCornerX - mTouch.x);
                float f2 = mWidth / 2 * f1 / mBezierStart1.x;
                mTouch.x = Math.abs(mCornerX - f2); // ���ｫBStart1.x��������С��mWidth��
                // ���¼����Ч��mTouch.x��ֵ
            ...
            if (mCornerX == mWidth && mBezierStart1.x < mWidth / 2) { // ���󻬶�ʱ
    ...
    public void computeScroll() {
        ...
        if (currentPosition == 17) {
            Toast.makeText(context, "�Ѿ������һҳ��", Toast.LENGTH_SHORT).show();
        }
        ...
        if (isAnimated && mScroller.isFinished()) { // ���������������һ֡�ģ����������Ӱ
            isAnimated = false;
            if (DragToRight()) {
                currentPosition -= 1;
            } else {
            ...
            System.out.println("currentPosition in computeScroll->"
                    + currentPosition);
    ...
    public void setAdapter(BaseAdapter adapter) {
        ...
        if (itemCount != 0) {
            ...
            if (itemCount > 1) {
                ...
                nextViewTranscript = mAdapter.getView(currentPosition + 1,
                        null, null);
                addView(nextView);
                addView(nextViewTranscript);
                System.out.println("setAdapter" + currentPosition);
            }
    ...
    private class FingerTouchListener implements OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            System.out.println("FingerTouchListener��currentPosition"
                    + currentPosition);
            // TODO Auto-generated method stub
            ...
            if (v == PageWidget.this && mAdapter != null) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    if (DragToRight()) {
                        System.out.println("DragToRight()" + DragToRight());
                        ...
                        System.out.println("elseesleDragToRight()"
                                + DragToRight());
